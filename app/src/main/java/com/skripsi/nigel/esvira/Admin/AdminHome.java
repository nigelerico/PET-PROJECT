...
public class AdminHome extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("Transaksi dalam proses");

        //Untuk inisialisasi fragment pertama kali
        fragmentManager.beginTransaction().replace(R.id.container_admin, new FragmentAdminHistoryInprogress()).commit();
...
//                        break;
                    case R.id.nav_gudang_admin:
                        toolbar.setTitle("Transaksi Dalam Proses");
                        fragment = new FragmentAdminHistoryInprogress();
                        loadFragment(fragment);
                        break;
                    case R.id.nav_transaksi_admin:
                        toolbar.setTitle("Transaksi Selesai");
                        fragment = new FragmentAdminHistoryCompleted();
                        loadFragment(fragment);
                        break;
