...
public class Adapterdetailtransaksi extends RecyclerView.Adapter<Adapterdetailtransaksi .MyViewHolder> {
    private int counter = 1;
    private int jumlah=1;
    Context mContext;
    ArrayList<Buku>keranjang;

    public Adapterdetailtransaksi (Context context, ArrayList<Buku> keranjang){
        this.mContext = context;
        this.keranjang = keranjang;
    }

    @Override
    public Adapterdetailtransaksi .MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
