...
public class SmaFragment extends Fragment implements  Callbacks {
    ...
    private com.skripsi.nigel.esvira.Adpater.CartAdapter CartAdapter;
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container,
        ...
        final View view = inflater.inflate(R.layout.fragment_sma, container, false);
            ...
            public void onResponse(JSONArray response) {
                ...
                try {
                    for (int i = 0; i < response.length(); i++) {
                        ...
                        if (jsonObject.getString("kategori").equals("SMA")) {
                        ...
                        if (jsonObject.getString("kategori").equals("SMA/UMUM")) {
                            listBuku.add(new Buku(Server.URLIMAGE + jsonObject.getString("foto"),
                                    jsonObject.getInt("id"),
                                    jsonObject.getString("nama"),
                                    jsonObject.getInt("harga"),
                        ...
                        if (jsonObject.getString("kategori").equals("SMP/SMA")) {
                            listBuku.add(new Buku(Server.URLIMAGE + jsonObject.getString("foto"),
                                    jsonObject.getInt("id"),
                                    jsonObject.getString("nama"),
                                    jsonObject.getInt("harga"),
                        ...
                        if (jsonObject.getString("kategori").equals("SMP/SMA/UMUM")) {
                            listBuku.add(new Buku(Server.URLIMAGE + jsonObject.getString("foto"),
                                    jsonObject.getInt("id"),
                                    jsonObject.getString("nama"),
                                    jsonObject.getInt("harga"),
