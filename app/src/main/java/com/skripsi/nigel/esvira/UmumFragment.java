...
public class UmumFragment extends Fragment implements  Callbacks {
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container,
        ...
        final View view = inflater.inflate(R.layout.fragment_umum, container, false);
            ...
            public void onResponse(JSONArray response) {
                ...
                try {
                    for (int i = 0; i < response.length(); i++) {
                        ...
                        if (jsonObject.getString("kategori").equals("UMUM")) {
